...
const variantClasses: Record<Variant, string> = {
  ...
  ghost:
    'bg-transparent text-fg hover:bg-hover active:bg-border border border-border',
  soft:
...
export function Button({
  ...
  return (
    <button
      type="button"
      className={cn(
        'inline-flex items-center justify-center gap-1.5 rounded-card font-bold transition-colors select-none cursor-pointer disabled:cursor-not-allowed',
